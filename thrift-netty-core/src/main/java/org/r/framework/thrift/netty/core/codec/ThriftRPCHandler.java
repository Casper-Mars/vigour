...
import org.r.framework.thrift.netty.core.NettyTransport;
...
public class ThriftRPCHandler extends ChannelInboundHandlerAdapter {

    private final Logger log = LoggerFactory.getLogger(ThriftRPCHandler.class);
    ...
    public ThriftRPCHandler(TProcessor processor) {
        this(processor,Executors.newCachedThreadPool());
    }

    public ThriftRPCHandler(TProcessor processor, Executor executor) {
